...
public class Rectangle implements Shape, WritableComparable<Rectangle> {
  ...
  public void draw(Graphics g, Rectangle fileMBR, int imageWidth,
    ...
    int s_x1 = (int) ((this.x1 - fileMBR.x1) * imageWidth / fileMBR.getWidth());
    int s_y1 = (int) (((vflip? -this.y1 : this.y1) - fileMBR.y1) * imageHeight / fileMBR.getHeight());
    int s_x2 = (int) ((this.x2 - fileMBR.x1) * imageWidth / fileMBR.getWidth());
    int s_y2 = (int) (((vflip? -this.y2 : this.y2) - fileMBR.y1) * imageHeight / fileMBR.getHeight());
